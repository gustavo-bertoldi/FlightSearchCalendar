<script lang="ts">
	...
	setContext('API_URL', 'https://fs-front-u6o6sehtja-nw.a.run.app:3000');
...
<main>
	<MaterialApp>
		...
		<Row class="d-flex justify-center pl-8 pr-8 pl-md-0 pr-md-0">
			<Col sm={12} md={10} lg={7}>
				<TripView bind:this={tripView} on:changeFlights={changeFlights} />
			</Col>
		</Row>
		<Snackbar class="flex-column" bind:active={errorBar} top center timeout={5000}
			>An internal error occurred. Please try again.</Snackbar>
	</MaterialApp>
</main>
