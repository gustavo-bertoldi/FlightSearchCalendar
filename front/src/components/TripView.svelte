...
{#if trip}
	...
	<div class="change-flights d-flex justify-space-between align-center">
		<span style="font-size: 18px; padding: 20px 0px;">Departing on {trip.outbound.departureDate}</span>
		<Button class="change-flights-btn" text on:click={() => dispatcher('changeFlights')}>Change flights</Button>
	</div>
